...
/***/ function(module, exports, __webpack_require__) {
	...
	var _buttons = __webpack_require__(94);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = [{
	    name: "bold",
	    title: "加粗",
	    icon: __webpack_require__(95),
	    action: "execCommand",
	    arg: "bold"
	}, {
	    name: "italic",
	    title: "倾斜",
	    icon: __webpack_require__(96),
	    action: "execCommand",
	    arg: "italic"
	}, {
	    name: "underline",
	    title: "下划线",
	    icon: __webpack_require__(97),
	    action: "execCommand",
	    arg: "underline"
	}, {
	    name: "color",
	    title: "文字颜色",
	    icon: __webpack_require__(98),
	    action: "toggleDashboard",
	    arg: "color"
	}, {
	    name: "link",
	    title: "加链接",
	    icon: __webpack_require__(99),
	    action: "toggleDashboard",
	    arg: "link"
	}, {
	    name: "unlink",
	    title: "去除链接",
	    icon: __webpack_require__(100),
	    action: "execCommand",
	    arg: "unlink"
	}, {
	    name: "insertOrderedList",
	    title: "有序列表",
	    icon: __webpack_require__(101),
	    action: "execCommand",
	    arg: "insertOrderedList"
	}, {
	    name: "insertUnorderedList",
	    title: "无序列表",
	    icon: __webpack_require__(102),
	    action: "execCommand",
	    arg: "insertUnorderedList"
	}, {
	    name: "insertHorizontalRule",
	    title: "分隔线",
	    icon: __webpack_require__(103),
	    action: "execCommand",
	    arg: "insertHorizontalRule"
	}, {
	    name: "table",
	    title: "表格",
	    icon: __webpack_require__(104),
	    action: "toggleDashboard",
	    arg: "table"
	}, {
	    name: "image",
